...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponseBFZDgithub.com/user/go-templates/template-grpc-ddd/gen/go/user/v1;userv1b\x06proto3"
